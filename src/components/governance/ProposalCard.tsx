		...
		<div className="w-full rounded-lg border p-4">
			...
			<div className="space-y-2 text-sm">
				...
				<div className="flex items-center justify-between">
					...
					<span className="font-mono truncate max-w-[220px]">{proposal.descriptionHash}</span>
				</div>
			</div>
			<div className="mt-4 flex items-center justify-between">
				<VoteButtons proposalId={proposal.id} onVoted={onChanged} />
				<button className="h-9 px-4 rounded-md border disabled:opacity-50" disabled={proposal.finalized || proposal.status !== "ended" || isFinalizing} onClick={onFinalize}>
